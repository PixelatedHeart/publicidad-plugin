				...
				public function form ($instance = FALSE)
					{
						...
						*/
						echo '<label for="' . esc_attr ($this->get_field_id ("title")) . '">Identificador (no aparece):</label><br />' . "\n";
						...
						echo '<strong>Modifica el código inferior para ajustarlo a tus necesidades</strong><br />' . "\n";
						echo 'Modifica la URL de enlace e imagen o bórralo y añade un código de AdSense' . "\n";
						echo '</label><br />' . "\n";
