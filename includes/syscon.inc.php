...
*/
$GLOBALS["WS_WIDGET__"]["ad_codes"]["c"]["name"] = "Publicidad";
$GLOBALS["WS_WIDGET__"]["ad_codes"]["c"]["control_w"] = "400"; /* Width of the control box. */
$GLOBALS["WS_WIDGET__"]["ad_codes"]["c"]["description"] = "Widget para publicidad";
/**/
		...
		function ws_widget__ad_codes_configure_options_and_their_defaults ($options = FALSE, $per_widget_options = FALSE)
			{
				...
				/**/
				"title" => "Ejemplo de publicidad", /* Ok for this to be empty. */
				/**/
				"code" => '<a rel="external" href="http://elclubexpress.com/" target="_new"><img src="' . esc_attr ($GLOBALS["WS_WIDGET__"]["ad_codes"]["c"]["dir_url"]) . '/images/300x250.png" style="width:300px; height:250px; border:0px;" alt="Publicidad" /></a>	
<!--rotate-->
<a rel="external" href="http://elclubexpress.com/" target="_new"><img src="' . esc_attr ($GLOBALS["WS_WIDGET__"]["ad_codes"]["c"]["dir_url"]) . '/images/300x250.png" style="width:300px; height:250px; border:0px;" alt="Publicidad" /></a>'));
				/*
