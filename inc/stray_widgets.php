...
class stray_widgets {
    ...
    function control($widget_args = 1) {
        ...
        <p><label><strong><?php _e('Título', 'stray-quotes')?></strong></label>
		...
		<p><label><strong><?php _e('Categorías', 'stray-quotes')?></strong><br/><span class="setting-description"><small><?php _e('Las publicidades se tomarán de estas categorías', 'stray-quotes')?></small></span></label>
